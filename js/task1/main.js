...
//
// let books = [
//     {title: 'asd1', pages: 10, genre: 'drama', authors: ['asd', 'wqe', 'fdgdfg']},
//     {title: 'asd2', pages: 101, genre: 'fantasy', authors: ['asd', 'wqe', 'fdgdfg']},
//     {title: 'asd3', pages: 102, genre: 'drama', authors: ['asd', 'wqe', 'fdgdfg']},
//     {title: 'asd4', pages: 104, genre: 'fantasy', authors: ['asd', 'wqe', 'fdgdfg']}
// ];
//
// console.log(books[0]);
// console.log(books[1]);
